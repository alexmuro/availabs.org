$(function(){
	...
	if(!isMobile()){
		$('.full_height').css('min-height', height);
		$('.half_height').css('min-height',(height/2));
	}
	if(typeof google !== 'undefined'){
	jQuery('#map').gMap({ 	address: '1400 Washington Ave,Albany, NY',
								panControl: true,
							   	zoomControl: true,
								zoomControlOptions: {
...
function scrollTo(elem){
	//console.log('scrolling to:',$(elem).offset().top,elem);
